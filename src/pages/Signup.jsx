                    ...
                    <fieldset>
                      <div className="container" data-aos="fade-up">
                        <div className="row">
                                    ...
                                    <div className="row ml-5 mr-5">
                                      <div className="col-md-6">
                                        <div className="card border border-primary">
                                          <div className="card-body">
                                            <i
                                              className="ri-user-fill text-primary float-left"
                                              style={{
                                                fontSize: "20px",
                                              }}
                                            ></i>
                                      ...
                                      <div className="col-md-6">
                                        <div className="card border border-primary">
                                          <div className="card-body">
                                            <i
                                              className="ri-building-line text-primary float-left"
                                              style={{
                                                fontSize: "20px",
                                              }}
                                            ></i>
                          ...
                          <div className="col-lg-6 pt- pt-lg-0 order-2 order-lg-1 content">
                      ...
                      <div className="container mb-5" data-aos="fade-up">
                        <div className="row">
                          <div className="col-lg-6 order-1 order-lg-2">
                            <div className="card">
                              <div className="card-body">
                                <h1 style={{ color: "#0800CF" }}>
                                  Sign up to hire talent
                                </h1>
                                <p>
                                  Please help us with below details to onboard
                                  you to our platform.
                                </p>
                                <br />
                                {/* <form> */}
